...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:CGRectMake(0, SCREEN_HEIGHT - 216, SCREEN_WIDTH, 216)]) {
...
- (void)createdKeyboard {
    ...
    CGFloat buttonWidth = (SCREEN_WIDTH - 1.5) / 3;
    CGFloat top = 0;
    UIColor * btnBgColorNormal = [UIColor whiteColor];//0xf7f7f7
    UIColor * btnBgColorHighlighted = ColorWithRGB(215, 215, 215, 1);//0xE7E8E9
...
//            [button.button setBackgroundImage:[HTButton imageColor:btnBgColorHighlighted] forState:UIControlStateNormal];
            [button.button setBackgroundImage:[HTButton imageColor:btnBgColorHighlighted] forState:UIControlStateNormal];
            [button.button setBackgroundImage:[HTButton imageColor:btnBgColorNormal] forState:UIControlStateHighlighted];
        }
        if (index == 9) {
            [button.button setBackgroundImage:[HTButton imageColor:btnBgColorHighlighted] forState:UIControlStateNormal];
            [button.button setBackgroundImage:[HTButton imageColor:btnBgColorNormal] forState:UIControlStateHighlighted];
//            button.button.titleLabel.font = [UIFont systemFontOfSize:23];
        }
