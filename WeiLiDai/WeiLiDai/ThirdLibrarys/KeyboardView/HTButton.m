...
- (instancetype)initWithFrame:(CGRect)frame {
    if (self = [super initWithFrame:frame]) {
        ...
        self.button.titleLabel.font = [UIFont systemFontOfSize:23];
//        self.button.frame = CGRectMake(0, 0, frame.size.width, frame.size.height -0.5);
        self.button.frame = CGRectMake(0, 0.5, frame.size.width, frame.size.height - 0.5);
...
//        [self.button setBackgroundImage:[HTButton imageColor:[UIColor colorWithHTRGB:0xE7E8E9]] forState:UIControlStateHighlighted];
        [self.button setBackgroundImage:[HTButton imageColor:btnBgColorNormal] forState:UIControlStateNormal];
        [self.button setBackgroundImage:[HTButton imageColor:btnBgColorHighlighted] forState:UIControlStateHighlighted];
