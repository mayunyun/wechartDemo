...
@interface ContactsViewController ()<UINavigationControllerDelegate,UIImagePickerControllerDelegate>
...
- (void)viewDidLoad {
    [super viewDidLoad];
    [self creatUI];
    self.navigationItem.rightBarButtonItem = [[UIBarButtonItem alloc] initWithImage:[[UIImage imageNamed:@"通讯录右上角"] imageWithRenderingMode:UIImageRenderingModeAlwaysOriginal]
...
-(void)myAlbum{
    ...
    if([UIImagePickerController isSourceTypeAvailable:UIImagePickerControllerSourceTypePhotoLibrary]){
        ...
        UIAlertController * alertC = [ContactsViewController showSingleBtnAlertControllerWithMessage:@"设备不支持访问相册，请在设置->隐私->照片中进行设置！"
                                                                                       doneBtnTitle:@"确定"
