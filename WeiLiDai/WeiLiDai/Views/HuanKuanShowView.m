...
static CGFloat showFrontViewH = 368/3;

@implementation HuanKuanShowView
...
-(HuanKuanShowFrontView *)showFrontView{
    if (!_showFrontView) {
        _showFrontView = [[HuanKuanShowFrontView alloc] initWithFrame:CGRectMake((self.frame.size.width - showFrontViewW)/2, - showFrontViewH*2, showFrontViewW, showFrontViewH)];
